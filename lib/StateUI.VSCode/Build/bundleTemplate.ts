...
// Copies the StateUIStarter template into out/Template/, laid out as in a
// checkout - the copy the extension writes a new application from when it is
// made against a release rather than a checkout.
