...
public class WindowTests
{
    ...
    private const string TreeWithOverlay = """
        {"id":1,"type":"Window","props":{"title":"App"},"arranged":true,"children":[
          {"id":2,"type":"Page","arranged":true,"children":[
            {"id":3,"type":"Label","props":{"text":"page"}}]},
          {"id":4,"type":"Overlay","arranged":true,"children":[
            {"id":5,"type":"Grid","props":{"ignoresInput":true},"arranged":true,"children":[
    ...
    public void AWindowShowsTheTitleBarTheTreeCarries()
    {
        ...
        var bar = Assert.IsType<StateUITitleBar>(window.TitleBar);
    ...
    public void ASparsePatchNamingAChildThisSideLacksIsRefusedRatherThanFatal()
    {
        ...
        bool applied = target.Apply(Host.Parse(Host.Application("""
            {"id":1,"type":"Window","children":[
              {"id":2,"type":"Page","children":[
                {"id":3,"type":"VStack","children":[
