...
public class ModalStackTests
{
    ...
    private static string Sheet(string identity, string title) =>
    ...
    public void APatchAboutASheetKeepsThePage()
    {
        ...
        pages.ApplyModals(window.Navigation, window, Host.Parse(
            ...
            + "{\"id\":\"0/settings\",\"type\":\"Page\",\"props\":{\"title\":\"Options\"}}]}"));
    ...
    public void ARebuiltSheetIsPresentedInPlaceOfTheOldOne()
    {
        ...
        pages.ApplyModals(window.Navigation, window, Host.Parse(
            "{\"id\":2,\"type\":\"ModalStack\",\"children\":["
            + "{\"id\":\"0/settings\",\"type\":\"Page\",\"replace\":true,"
    ...
    public void AModalStackThatLeavesTakesItsSheetsWithIt()
    {
        ...
        window.Apply(Host.Parse("""
            {"id":"main","type":"Window","arranged":true,"children":[
              {"id":1,"type":"Page","props":{"title":"Home"}},
              {"id":2,"type":"ModalStack","arranged":true,"children":[
                {"id":"settings","type":"Page","props":{"title":"Settings"},
