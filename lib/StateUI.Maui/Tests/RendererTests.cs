...
public class RendererTests
{
    ...
    public void WhatAScreenReaderIsToldGoesAwayWithTheModifier()
    {
        ...
        var again = (Label)host.Apply("""
            {"id":1,"type":"Label",
             "cleared":["accessibilityLabel","accessibilityHint","accessibilityHeadingLevel"]}
            """);
    ...
    public void AnAnchorIsWrittenAgainOnceTheViewHasASize()
    {
        ...
        var box = (BoxView)host.Apply("""
            {"id":1,"type":"ColorBox","props":{"pivotY":1,"rotation":45,"width":2,"height":96}}
            """);
    ...
    public void AnAnchorOnAViewThatAlreadyHasASizeIsLeftAlone()
    {
        ...
        var box = (BoxView)host.Apply("""
            {"id":1,"type":"ColorBox","props":{"width":2,"height":96}}
            """);

        ((IView)box).Arrange(new Rect(0, 0, 2, 96));

        host.Apply("""
            {"id":1,"type":"ColorBox","props":{"pivotY":1,"rotation":45}}
            """);
        ...
        var grid = (Grid)host.Apply("""
            {"id":1,"type":"Grid","arranged":true,"children":[
              ...
              {"id":3,"type":"Border","props":{"gridRow":1},"arranged":true,"children":[
                {"id":4,"type":"ColorBox","props":{"color":"#512BD4","cornerRadius":10,"translationX":81}}]}]}
            """);
        ...
        host.Apply("""
            {"id":1,"type":"Grid","arranged":true,"children":[
              ...
              {"id":7,"type":"Border","props":{"gridRow":1},"arranged":true,"children":[
                {"id":8,"type":"ColorBox","props":{"color":"#512BD4","cornerRadius":10,"translationX":81}}]}]}
            """);
    ...
    public void AnArrangedListTouchesOnlyWhatMoved()
    {
        ...
        host.Renderer.ApplyList(items, Host.Parse(
            $"{{\"id\":1,\"type\":\"VStack\",\"arranged\":true,\"children\":[{rows}]}}"),
    ...
    public void WritingAPropertyDoesNotReportItBackAsIfTheUserHadDoneIt()
    {
        ...
        host.Apply("""
            {"id":"e","type":"TextField","props":{"text":"one"},"events":{"textChanged":3}}
            """);

        // Assigning Entry.Text raises TextChanged; that is the renderer talking
        // to itself, and it must not travel.
        host.Apply("""{"id":"e","type":"TextField","props":{"text":"two"}}""");
    ...
    public void ATypedEventCarriesItsValue()
    {
        ...
        var toggle = (Switch)host.Apply("""
            {"id":"s","type":"Switch","props":{"isOn":false},"events":{"toggled":4}}
            """);
    ...
    public void TextTypedPastTheCapIsHeldToIt()
    {
        ...
        var field = (Entry)host.Apply("""
            {"id":"e","type":"TextField","props":{"maximumLength":5},"events":{"textChanged":7}}
            """);
    ...
    public void APropertyWithNoEventOfItsOwnIsWatchedOnlyWhenAsked()
    {
        ...
        var asked = (Entry)watched.Apply("""
            {"id":"e","type":"TextField","events":{"isFocusedChanged":6}}
            """);

        var ignored = new Host();
        var notAsked = (Entry)ignored.Apply("""{"id":"e","type":"TextField"}""");
    ...
    public void ATapRecognizerIsAddedOnceAndOnlyWhenTheTreeAsksForOne()
    {
        ...
        var tappable = (Border)host.Apply("""
            {"id":"a","type":"Border","props":{"tapCount":2},"events":{"tapped":3}}
            """);
        ...
        host.Apply("""{"id":"a","type":"Border","props":{"tapCount":1}}""");
    ...
    public void SwipeItemsAreKeptBetweenRendersAndOnlyWhatChangedIsWritten()
    {
        ...
        host.Apply("""
            {"id":1,"type":"SwipeView","children":[
              {"id":3,"type":"SwipeActions","children":[
                {"id":5,"type":"SwipeAction","props":{"text":"Remove"}}]}]}
            """);
        ...
        host.Apply("""
            {"id":1,"type":"SwipeView","children":[
              {"id":3,"type":"SwipeActions","arranged":true,"children":[
                {"id":5,"type":"SwipeAction"}]}]}
            """);
    ...
    public void ABoxViewsCornerRadiusTakesOneNumberAndFourUnderTheSameName()
    {
        ...
        var box = (BoxView)host.Apply("""
            {"id":1,"type":"ColorBox","props":{"cornerRadius":8}}
            """);

        Assert.Equal(new CornerRadius(8), box.CornerRadius);

        var corners = (BoxView)host.Apply("""
            {"id":2,"type":"ColorBox","props":{"cornerRadius":[16,16,0,0]}}
            """);
    ...
    public void TheInputTierLandsOnEveryInputView()
    {
        ...
        // fixture's Entry - which covers ReconcileTextField and nothing else. All
