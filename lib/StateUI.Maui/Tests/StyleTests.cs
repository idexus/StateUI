...
public class StyleTests
{
        ...
        var button = (Button)host.Apply("""
            {"id":1,"type":"Button","props":{"isEnabled":false,"background":"#F09072"},"children":[
              ...
              {"id":3,"type":"VisualState",
               ...
               "children":[{"id":4,"type":"Setters","props":{"background":"#2C2838"}}]}]}
            """);
    ...
    public void AStateColourSurvivesAPatchThatRestatesTheProperty()
    {
        ...
        host.Apply("""{"id":1,"type":"Button","props":{"background":"#123456"}}""");
        clock.Tick(1000);
    ...
    public void AColourReachesABrushProperty()
    {
        ...
        var border = (Border)host.Apply("""
            {"id":1,"type":"Border","props":{"stroke":"#C8C8C8","strokeWidth":1}}
            """);
    ...
    public void AColourReachesTheBarOfTheStackDrawingIt()
    {
        ...
        window.Apply(Host.Parse("""
            {"id":1,"type":"Window","children":[
              {"id":2,"type":"NavigationStack","arranged":true,
               "props":{"barBackgroundColor":"#512BD4","barForegroundColor":"#FFFFFF"},"children":[
                {"id":"root","type":"Page","props":{"background":"#FFFFFF"},
    ...
    public void APictureReachesATabsIcon()
    {
        ...
        window.Apply(Host.Parse("""
            {"id":1,"type":"Window","children":[
              {"id":2,"type":"TabbedView","arranged":true,"props":{"currentPage":0},"children":[
                {"id":"home","type":"Page",
                 "props":{"title":"Home","icon":"nav_home.png"},"children":[
            ...
            {"id":1,"type":"Label","props":{"text":"one"},"arranged":true,"children":[
              ...
              {"id":3,"type":"VisualState",
               ...
               "children":[{"id":4,"type":"Setters",
                            "props":{"textColor":"#FF0000","background":"#0000FF"}}]}]}
            """);

        var label = (Label)host.Apply("""
            {"id":1,"type":"Label","children":[
              {"id":3,"type":"VisualState",
               "children":[{"id":4,"type":"Setters","cleared":["background"]}]}]}
            """);
    ...
    /// </summary>
    /// <remarks>
    /// A SwipeAction is MAUI's SwipeItem, a MenuItem, and SwipeActions the
    /// collection holding them: neither is a View, neither has a Style MAUI
    /// would apply to it, and the Swift side cannot write one - a StyleTarget
    /// is a VisualElement. Named here for the same reason Fixtures.notViews
    /// names them on the Swift side.
    /// </remarks>
    private static readonly HashSet<string> NotControls =
    [
        "SwipeAction", "SwipeActions",
        "Spans", "Span",
        "ToolbarItem", "Menu", "MenuItem", "MenuSeparator",
        "ContextMenu",
        "Pin",
    ];

    /// <summary>
    /// The contract's properties MAUI has nothing to hold, by control - named
    /// here so the guards below still cover every other one.
    /// </summary>
    /// <remarks>
