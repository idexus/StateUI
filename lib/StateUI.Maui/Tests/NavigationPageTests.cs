...
public class NavigationPageTests
{
    ...
    private static string Stack(params string[] pages) =>
        "{\"id\":1,\"type\":\"NavigationStack\",\"events\":{\"popped\":7},"
    ...
    private static string TabsAt(int id, params string[] pages) =>
        $"{{\"id\":{id},\"type\":\"TabbedView\",\"arranged\":true,"
    ...
    public void AWatchedFrameListensNoHigherThanItsPage()
    {
        ...
        var navigation = Assert.IsType<NavigationPage>(pages.Render(
            null,
            Host.Parse(Stack("""
                {"id":2,"type":"Page","props":{"title":"Home"},"arranged":true,"children":[
                  {"id":3,"type":"VStack","arranged":true,"children":[
    ...
    private static string WatchFrameBody()
    {
        ...
        while (directory is not null && file is null)
        {
            string candidate = Path.Combine(
                directory.FullName, "lib", "StateUI.Maui", "Sources", "Rendering", "StateUIRenderer.cs");
    ...
    public void APatchThatIsNotAnArrangementLeavesTheStackAlone()
    {
        ...
        pages.Render(navigation, Host.Parse("""
            {"id":1,"type":"NavigationStack","children":[
              {"id":3,"type":"Page","props":{"title":"Renamed"}}]}
            """));
    ...
    public void ARebuiltRootIsSwappedOntoTheStack()
    {
        ...
        pages.Render(navigation, Host.Parse(
            "{\"id\":1,\"type\":\"NavigationStack\",\"children\":["
            + "{\"id\":2,\"type\":\"Page\",\"replace\":true,\"props\":{\"title\":\"Fresh\"},"
    ...
    public void ARebuiltPageOnTopIsSwappedOntoTheStack()
    {
        ...
        pages.Render(navigation, Host.Parse(
            "{\"id\":1,\"type\":\"NavigationStack\",\"children\":["
            + "{\"id\":3,\"type\":\"Page\",\"replace\":true,\"props\":{\"title\":\"Rebuilt\"},"
    ...
    public void TwoStacksDoNotShareARootPage()
    {
        ...
        string outer =
            ...
            + "{\"id\":2,\"type\":\"Page\",\"props\":{\"title\":\"Outer home\"},\"arranged\":true,"
            + "\"children\":[{\"id\":102,\"type\":\"Label\",\"props\":{\"text\":\"outer\"}}]},"
            + "{\"id\":3,\"type\":\"NavigationStack\",\"arranged\":true,\"children\":["
            + "{\"id\":4,\"type\":\"Page\",\"props\":{\"title\":\"Inner home\"},\"arranged\":true,"
    ...
    public void AChildThatIsNotAPageIsReported()
    {
        ...
        pages.Render(null, Host.Parse(
            "{\"id\":1,\"type\":\"NavigationStack\",\"arranged\":true,\"children\":["
            + "{\"id\":2,\"type\":\"Page\",\"props\":{\"title\":\"Home\"},\"arranged\":true,"
    ...
    public void ALaterPatchRepaintsTheBar()
    {
        ...
        var navigation = Assert.IsType<NavigationPage>(
            pages.Render(null, Host.Parse(
                "{\"id\":1,\"type\":\"NavigationStack\",\"arranged\":true,"
        ...
        pages.Render(navigation, Host.Parse(
            "{\"id\":1,\"type\":\"NavigationStack\",\"props\":{\"barBackgroundColor\":\"#FF0000\"}}"));
