...
public class PageBarTests
{
                ...
                {"id":"file","type":"Menu","props":{"text":"File"},"arranged":true,"children":[
                  {"id":"new","type":"MenuItem",
                   "props":{"text":"New","isDestructive":false,
                            "icon":"nav_media.png"},
                   "events":{"clicked":12}},
                  {"id":"sep","type":"MenuSeparator"},
                  {"id":"recent","type":"Menu","props":{"text":"Recent"},
    ...
    public void AToolbarItemAndAMenuEntryReportWhatTheyWereGiven()
    {
        ...
        host.Renderer.ApplyList(page.MenuBarItems, Host.Parse("""
            {"id":8,"type":"MenuBar","arranged":true,"children":[
              {"id":"file","type":"Menu","props":{"text":"File"},"arranged":true,"children":[
                {"id":"new","type":"MenuItem","props":{"text":"New"},
                 "events":{"clicked":12}}]}]}
    ...
    {
        ContentPage page = Page("""
            {"id":5,"type":"Page","props":{"useSafeArea":false},"children":[
...
#pragma warning restore CS0618
    ...
    {
        ContentPage page = Page("""
            {"id":5,"type":"Page","props":{"title":"Plain"}}
            """);
