...
public class ContextMenuTests
{
    ...
    public void AMenuIsAttachedToTheViewAndFilledWithItsEntries()
    {
        ...
        var label = Assert.IsType<Label>(host.Apply("""
            {"id":1,"type":"Label","props":{"text":"row"},"children":[
              {"id":2,"type":"ContextMenu","arranged":true,"children":[
                {"id":3,"type":"MenuItem","props":{"text":"Rename"},"events":{"clicked":7}},
                {"id":4,"type":"MenuSeparator"},
                {"id":5,"type":"Menu","props":{"text":"Move"},"arranged":true,"children":[
                  {"id":6,"type":"MenuItem","props":{"text":"Up"}}]}]}]}
            """));
    ...
    public void AMenuIsKeptAndPatchedRatherThanBuiltAgain()
    {
        ...
        var label = Assert.IsType<Label>(host.Apply("""
            {"id":1,"type":"Label","props":{"text":"row"},"children":[
              {"id":2,"type":"ContextMenu","arranged":true,"children":[
                {"id":3,"type":"MenuItem","props":{"text":"Rename"}},
                {"id":4,"type":"MenuItem","props":{"text":"Delete"},"events":{"clicked":9}}]}]}
            """));
        ...
        host.Apply("""
            {"id":1,"type":"Label","children":[
              {"id":2,"type":"ContextMenu","children":[
                {"id":4,"type":"MenuItem","props":{"text":"Remove"}}]}]}
            """);
    ...
    public void AnEntryThatLeavesIsTheOnlyOneThatGoes()
    {
        ...
        var label = Assert.IsType<Label>(host.Apply("""
            {"id":1,"type":"Label","children":[
              {"id":2,"type":"ContextMenu","arranged":true,"children":[
                {"id":3,"type":"MenuItem","props":{"text":"Rename"}},
                {"id":4,"type":"MenuItem","props":{"text":"Delete"}}]}]}
            """));
    ...
    public void TheSlotIsNotOneOfTheLayoutsChildren()
    {
        ...
        var stack = Assert.IsAssignableFrom<VerticalStackLayout>(host.Apply("""
            {"id":1,"type":"VStack","arranged":true,"children":[
              ...
              {"id":4,"type":"ContextMenu","arranged":true,"children":[
                {"id":5,"type":"MenuItem","props":{"text":"Copy"}}]}]}
            """));
    ...
    public void ASingleContentViewKeepsItsContent()
    {
        ...
        var border = Assert.IsType<Border>(host.Apply("""
            {"id":1,"type":"Border","arranged":true,"children":[
              ...
              {"id":3,"type":"ContextMenu","arranged":true,"children":[
                {"id":4,"type":"MenuItem","props":{"text":"Copy"}}]}]}
            """));
