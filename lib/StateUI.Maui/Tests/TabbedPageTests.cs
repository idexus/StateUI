...
public class TabbedPageTests
{
    ...
    private static string TabAt(string tab, string title) =>
        $"{{\"id\":\"{tab}\",\"type\":\"Page\","
        + $"\"props\":{{\"title\":\"{title}\",\"icon\":\"{tab}.png\"}},"
    ...
    private static string Bar(int? current, params string[] tabs)
    {
        ...
        return "{\"id\":1,\"type\":\"TabbedView\",\"events\":{\"currentPageChanged\":9},"
            + selection
    ...
    public void ALaterPatchMovesTheSelection()
    {
        ...
        pages.Render(tabbed, Host.Parse(
            "{\"id\":1,\"type\":\"TabbedView\",\"props\":{\"currentPage\":1}}"));
    ...
    public void ARebuiltTabIsSwappedIntoTheBar()
    {
        ...
        pages.Render(tabbed, Host.Parse(
            "{\"id\":1,\"type\":\"TabbedView\",\"children\":["
            + "{\"id\":\"home\",\"type\":\"Page\",\"replace\":true,"
    ...
    public void TwoTabBarsDoNotShareAPage()
    {
        ...
        string outer =
            ...
            + "{\"id\":\"nested\",\"type\":\"TabbedView\",\"arranged\":true,\"children\":["
    ...
    public void ATabCanHoldAWholeStack()
    {
        ...
        var tabbed = Assert.IsType<TabbedPage>(pages.Render(null, Host.Parse(
            "{\"id\":1,\"type\":\"TabbedView\",\"arranged\":true,\"children\":["
            + "{\"id\":\"home\",\"type\":\"NavigationStack\",\"arranged\":true,"
            + "\"props\":{\"title\":\"Home\",\"icon\":\"house.png\"},"
