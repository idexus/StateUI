...
/// </para>
/// <para>
/// <c>MauiRealizationTests</c> holds the dictionary's MAUI column equal to
/// these records, and <c>python3 .scripts/controls-dictionary.py</c> writes the
/// column from them, reading this file.
/// </para>
/// </remarks>
internal static class MauiRealization
{
    ...
    [
        ...
        Partial("Map", "address", missing: "Windows and Linux have no map; the Map draws the unknown-control marker there."),
        ...
        Partial("Map", "label", missing: "Windows and Linux have no map; the Map draws the unknown-control marker there."),
        Partial("Map", "location", missing: "Windows and Linux have no map; the Map draws the unknown-control marker there."),
        ...
        Partial("Map", "pinClicked", missing: "Windows and Linux have no map; the Map draws the unknown-control marker there."),
        Partial("Map", "pinDetailsClicked", missing: "Windows and Linux have no map; the Map draws the unknown-control marker there."),
        Partial("Map", "showsUserLocation", missing: "Windows and Linux have no map; the Map draws the unknown-control marker there."),
        Partial("Map", "type", missing: "Windows and Linux have no map; the Map draws the unknown-control marker there."),
        ...
        Complete("SwipeView", "background"),
        Complete("SwipeView", "isVisible"),
        Complete("SwipeView", "side"),
