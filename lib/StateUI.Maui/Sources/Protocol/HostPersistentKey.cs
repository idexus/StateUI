...
/// <see cref="WireCodec.ReadPersistentKeys"/> - because a settings store is
...
internal readonly record struct HostPersistentKey(string Name, HostPersistentKind Kind);
