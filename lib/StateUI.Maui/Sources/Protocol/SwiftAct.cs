...
public enum SwiftAct : ushort
{
    ...
    EvaluateJavaScript = 21,

    /// <summary>Map.MoveToRegion.</summary>
    MoveToRegion = 22,

    /// <summary>OnScreenKeyboard.hide() - this library's own, MAUI having no method.</summary>
    HideOnScreenKeyboard = 25,

    /// <summary>Page.DisplayAlertAsync with one button - Dialogs.alert.</summary>
    Alert = 26,

    /// <summary>
    /// Page.DisplayAlertAsync with an accept and a cancel button, answering
    /// which was pressed - Dialogs.confirm.
    /// </summary>
    Confirm = 37,
