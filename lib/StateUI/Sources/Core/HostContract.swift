...
@_spi(Host) public struct HostContract {
    ...
    public static let properties: [Prop: HostPropertyOwner] = table([
        (.native, [
            ...
            .horizontalAlignment, .horizontalTextAlignment, .imageSource,
            .increment, .ignoresInput, .isAnimationPlaying, .letsInputThrough,
            ...
            .maximumTrackColor, .maximumWidth,
            .maximumLength, .maximumLines, .minimum, .minimumDate, .minimumHeight,
            .minimumTrackColor, .minimumWidth, .offColor, .onColor, .opacity, .orientation,
        ...
        (.adaptive, [
            ...
            .showsClearButton, .contentLayout, .floatsOnTop,
            ...
            .order, .priority, .returnKey, .safeAreaEdges, .searchIconColor,
        ...
        (.structure, [
            ...
            .currentPage, .drawable, .frame, .group, .itemsSource,
