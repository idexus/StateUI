...
///
/// EMPTY, because an ImageButton has nothing of its own: `aspect` is
/// `ImageElement`'s, the padding and the border belong to their own mixins,
/// and the picture goes in the initializer. The protocol stays
