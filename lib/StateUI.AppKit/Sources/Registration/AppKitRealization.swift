...
enum AppKitRealization {
    ...
    static let records: [AppKitRealization] = [
        ...
        .complete("Grid", "shape"),
        .partial("Grid", "stroke", missing: "AppKit strokes with a colour; a gradient brush draws no outline."),
        .complete("Grid", "strokeWidth"),
        .complete("HStack", "background"),
        .complete("HStack", "shape"),
        .partial("HStack", "stroke", missing: "AppKit strokes with a colour; a gradient brush draws no outline."),
        .complete("HStack", "strokeWidth"),
        .complete("VStack", "background"),
        .complete("VStack", "shape"),
        .partial("VStack", "stroke", missing: "AppKit strokes with a colour; a gradient brush draws no outline."),
