...
final class DrivenWireTests: XCTestCase {
    ...
    func testEveryDrivenModifierIsWrittenDown() throws {
        let number = Hosted(wrappedValue: AnimatedValue(0.5))
        let colour = Hosted(wrappedValue: AnimatedValue(Color("#102030")))
        let inset = Hosted(wrappedValue: AnimatedValue(Thickness(4)))
    ...
    func testDrivenTextIsWrittenDown() throws {
        let caption = Hosted(wrappedValue: "60%")
    ...
    func testADrivenInputIsWrittenDown() throws {
        let level = Hosted(wrappedValue: AnimatedValue(0.5))
        let steps = Hosted(wrappedValue: AnimatedValue(3.0))
    ...
    func testADrivenPlacedLayoutIsWrittenDown() throws {
        let run = Hosted(wrappedValue: PlacedRun())
    ...
    func testTwoDrivenPropertiesOnOneElementNumberInTheOrderTheirNamesDo() {
        let moved = Hosted(wrappedValue: AnimatedValue(0.0))
        let faded = Hosted(wrappedValue: AnimatedValue(1.0))
        let differ = Differ()
