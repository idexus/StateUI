...
dictionary](controls/README.md), rendered from the contracts and from each
host's declaration of what it realizes; the counts under [Control
dictionary](#control-dictionary) are rendered with it.
