...
The slot holding the view a container shows in its central place - a title bar's middle.
...
Declared in `lib/StateUI/Sources/Contracts/Elements/Slots/ContentContract.swift`.

## Content's own members

Content declares no members of its own.
