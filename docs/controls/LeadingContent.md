...
The slot holding the view a container shows before its title - a title bar's leading view.
...
Declared in `lib/StateUI/Sources/Contracts/Elements/LeadingContentContract.swift`.

## LeadingContent's own members

LeadingContent declares no members of its own.
