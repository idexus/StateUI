...
Declared in `lib/StateUI/Sources/Contracts/Elements/Collections/SwipeViewContract.swift`.

## SwipeView's own members

| Member | Kind | Value | Layer | MAUI | AppKit | UIKit | GTK 4 | Android Views | WinUI 3 | Web | Notes |
| --- | --- | --- | --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | --- |
| `onSwipeChanging` (`swipeChanging`) | event | `(SwipeDirection, Double)` | stateUI | ✅ |  |  |  |  |  |  |  |
| `onSwipeEnded` (`swipeEnded`) | event | `(SwipeDirection, Bool)` | stateUI | ✅ |  |  |  |  |  |  |  |
| `onSwipeStarted` (`swipeStarted`) | event | `SwipeDirection` | stateUI | ✅ |  |  |  |  |  |  |  |
| `threshold` | property | `Double` | stateUI | ✅ |  |  |  |  |  |  |  |
