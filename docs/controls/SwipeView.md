...
Declared in `lib/StateUI/Sources/Views/SwipeView.swift`.
...
| `isVisible` | property |  |  |  |  |  |  |  |  |
| `side` | property |  |  |  |  |  |  |  |  |
| `onSwipeChanging` (`swipeChanging`) | handler |  |  |  |  |  |  |  |  |
| `onSwipeEnded` (`swipeEnded`) | handler |  |  |  |  |  |  |  |  |
| `onSwipeStarted` (`swipeStarted`) | handler |  |  |  |  |  |  |  |  |
| `threshold` | property |  |  |  |  |  |  |  |  |
