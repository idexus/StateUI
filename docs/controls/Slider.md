...
Declared in `lib/StateUI/Sources/Views/Slider.swift`.

## Slider's own members

| Member | Kind | MAUI | AppKit | UIKit | GTK 4 | Android Views | WinUI 3 | Web | Notes |
| --- | --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | --- |
| `onDragCompleted` (`dragCompleted`) | handler | ✅ | ✅ |  |  |  |  |  |  |
| `onDragStarted` (`dragStarted`) | handler | ✅ | ✅ |  |  |  |  |  |  |
| `maximum` | property | ✅ | ✅ |  |  |  |  |  |  |
| `minimum` | property | ✅ | ✅ |  |  |  |  |  |  |
| `value` | property | ✅ | ✅ |  |  |  |  |  |  |
| `onValueChanged` (`valueChanged`) | handler | ✅ | ✅ |  |  |  |  |  |  |
