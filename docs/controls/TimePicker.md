...
| `format` | property | `String` | native |  |  |  | ✅ | ☑️ |  | WinUI 3: WinUI's time picker writes hours and minutes as the user's clock does, whatever the format asks: no seconds, no pattern. |
