...
Inherits: [PropertyContainer](tiers/PropertyContainer.md) · [VisualElement](tiers/VisualElement.md) · [View](tiers/View.md) · [Layout](tiers/Layout.md) · [PaddingElement](tiers/PaddingElement.md)
...
Declared in `lib/StateUI/Sources/Views/AbsoluteLayout.swift`.

## AbsoluteLayout's own members

AbsoluteLayout declares no members of its own; everything it takes comes from the sections below.
