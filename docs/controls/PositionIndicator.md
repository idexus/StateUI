...
Declared in `lib/StateUI/Sources/Contracts/Elements/PositionIndicatorContract.swift`.
...
| `indicatorColor` | property | `Color` | stateUI | ✅ |  |  |  |  |  |  |  |
| `indicatorSize` | property | `Double` | stateUI | ✅ |  |  |  |  |  |  |  |
| `indicatorsShape` | property | `IndicatorShape` | stateUI | ✅ |  |  |  |  |  |  |  |
