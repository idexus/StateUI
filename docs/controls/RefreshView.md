...
| --- | --- | --- | --- | :---: | :---: | :---: | :---: | :---: | :---: | :---: | --- |
| `isRefreshEnabled` | property | `Bool` | stateUI | ✅ |  |  |  |  |  |  |  |
| `isRefreshing` | property | `Bool` | stateUI | ✅ |  |  |  |  |  |  |  |
| `isRefreshingChanged` | event | `Bool` | stateUI | ✅ |  |  |  |  |  |  |  |
| `onRefreshRequested` (`refreshRequested`) | event |  | stateUI | ✅ |  |  |  |  |  |  |  |
