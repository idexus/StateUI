...
**This includes the right to license Your Contribution under terms other than
the Project's current licence**, including proprietary terms, whether alone or
as part of a larger work. You are not entitled to any payment for this, and nothing
here withdraws what is already public: code released under the Project's open
source licence stays available under that licence, whose grant is irrevocable.
...
3. If Your employer has rights to intellectual property You create, You have
   ...
   Your employer has waived those rights, or Your employer has agreed in writing
   with the Owner that You may contribute.

## 5. Work that is not Yours

You may submit work that is not Your original creation, provided it is clearly
identified as such, together with its source and any licence or other
restriction You are aware of, and marked "Submitted on behalf of a third party:
[named here]".

## 6. No obligations, no warranty

You are not expected to provide support for Your Contributions, and may choose
to or not. Unless required by applicable law or agreed in writing, You provide
Your Contributions on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY
KIND, either express or implied, including any warranty of TITLE,
NON-INFRINGEMENT, MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.

## 7. Keeping it true

You agree to notify the Owner of any facts or circumstances of which You become
aware that would make these representations inaccurate.
