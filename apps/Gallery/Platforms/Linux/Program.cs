...
// as reachable on Windows and macOS too, and answers CA1416. This is the head
// that is only ever built and run on Linux, which is what the attribute says.
...
/// builder is handed over as an override rather than run before it. What the
/// loop needs under it - a synchronization context that posts back to it - is
/// <c>StateUIApplication.Start</c>'s and not this file's.
/// </remarks>
