...
/// <summary>
/// A count bubble over whatever it holds - an ordinary MAUI control with one
/// slot for content it does not describe itself.
/// </summary>
/// <remarks>
/// The registration's <c>content</c> fills that slot (see
...
/// <see cref="Inner"/> - created, patched and kept by identity.
/// </remarks>
public sealed class Badge : ContentView
{
    ...
    /// that updates the held view in place never lands here.
    /// </summary>
    public View? Inner
    {
        set
    ...
    public Badge()
    {
        // Every colour is set locally, so a badge looks like a badge in any
        // application that adopts it.
        _count = new Label
        {
