...
struct AnimationSample: SampleContent {
    ...
    @State(asks: .never) private var shift = AnimatedValue(0.0)
    @State(asks: .never) private var scale = AnimatedValue(1.0)
    @State(asks: .never) private var angle = AnimatedValue(0.0)
