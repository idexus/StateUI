...
struct AnalogClockSample: SampleContent {
    ...
    @Hosted private var sAngle = AnimatedValue(0.0)
    @Hosted private var mAngle = AnimatedValue(0.0)
    @Hosted private var hAngle = AnimatedValue(0.0)
    ...
    static let code = """
        ...
        private func hand(
            _ angle: Bus<AnimatedValue<Double>>,
