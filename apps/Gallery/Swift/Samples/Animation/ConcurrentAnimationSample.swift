...
struct ConcurrentAnimationSample: SampleContent {
    ...
    @State(asks: .never) private var hop0 = AnimatedValue(0.0)
    @State(asks: .never) private var hop1 = AnimatedValue(0.0)
    @State(asks: .never) private var hop2 = AnimatedValue(0.0)
    @State(asks: .never) private var hop3 = AnimatedValue(0.0)
    ...
    @State(asks: .never) private var wash = AnimatedValue(Palette.accent)

    /// How opaque the caption is.
    @State(asks: .never) private var breath = AnimatedValue(1.0)
