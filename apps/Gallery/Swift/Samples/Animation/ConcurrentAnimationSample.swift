...
struct ConcurrentAnimationSample: SampleContent {
    ...
    @DrivenState private var hop0 = AnimatedValue(0.0)
    @DrivenState private var hop1 = AnimatedValue(0.0)
    @DrivenState private var hop2 = AnimatedValue(0.0)
    @DrivenState private var hop3 = AnimatedValue(0.0)
    ...
    @DrivenState private var wash = AnimatedValue(Palette.accent)

    /// How opaque the caption is.
    @DrivenState private var breath = AnimatedValue(1.0)
