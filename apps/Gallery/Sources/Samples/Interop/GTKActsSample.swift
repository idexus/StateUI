...
struct GTKActsSample: SampleContent, ExampleContent {
    ...
    var content: any View {
        VStack {
            ...
            TextField($draft)
                .accessibilityIdentifier("gtkActs.draft")
    ...
    var notes: Element? {
        VStack {
            Label("`StateUIActs.add` registers a function under an act the "
                ...
                + "A performer may await: GTK reads the clipboard asynchronously.")
                .fontSize(12)
