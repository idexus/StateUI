...
struct AppKitActsSample: SampleContent, ExampleContent {
    ...
    var content: any View {
        VStack {
            ...
            TextField($draft)
                .accessibilityIdentifier("appKitActs.draft")
    ...
    var notes: Element? {
        VStack {
            Label("`StateUIAppKit.performs` registers a function under an act the "
            ...
            Label("An act of a control's own is declared in the control's contract and "
                ...
                + "0, and the host turns it back into the view it made - so the performer "
                + "is handed that view itself.")
                .fontSize(12)
                .textColor(Palette.subtle)
        }
        .spacing(12)
