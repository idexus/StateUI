...
final class TemplateTests: XCTestCase {
    ...
    /// repository-only scaffolder and named Gallery bundler, neither of which
    /// can describe an application generated elsewhere.
    func testTheTemplateShipsTheRepositorysOwnBuild() throws {
        ...
        XCTAssertTrue(
            pack.contains("build-gallery-appkit.sh"),
            "the template no longer leaves the Gallery-only bundler out.")
